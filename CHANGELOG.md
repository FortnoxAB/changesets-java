...
- Add support for handling dependency updates separately from other changesets, so that they can be presented in a more organised way. This is utilized by setting the update type to `dependency` in place of major/minor/patch.
